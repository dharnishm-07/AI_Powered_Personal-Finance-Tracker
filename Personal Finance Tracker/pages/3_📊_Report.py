...
co = cohere.Client(api_key = "dYZorKnP9nNLXrP3Fo1m5J3GiS2HPiATDR73tbAy")
...
# Category-wise Monthly Bar Chart
if not expenses_df.empty:
...
with st.expander("Chat with SynBot", expanded=False):
	st.write(f"Hi {st.session_state.get('user_email', 'User').split('@')[0]}! How can I help you today?")
